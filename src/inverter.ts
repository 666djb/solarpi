...
export abstract class Inverter {
    ...
    public abstract sendCommand(modbusClient: ModbusRTU, command: string): Promise<ControlData | void>
    public abstract updateControl(subTopic: string, controlMessage: string): ControlData[]
